 ...
 */
//@Autonomous(name = "BeaconsBlue")
public class BeaconsBlue extends LinearOpMode {
    ...
    //TURN LEFT ONLY WITH RIGHT MOTORS
    ...
    public void Todo() {
        ...
        // TURN LEFT TO LINE UP WITH THE WHITE LINE
     /*   while (currentHeading < 125) {  //PILA EN 13v ( ), EN -13v (308)
            GirarIzquierda1(.3);
            currentHeading = GyroSensor.getHeading();
            telemetry.addData("Heading ", currentHeading);
            telemetry.update();
        ...
        */
        ...
        //DAR VUELTA PARA BEACON 1
        while (currentHeading < 173) {  //PILA EN 13v ( ), EN -13v (70)
            GirarDerecha(.2);
            currentHeading = GyroSensor.getHeading();
            telemetry.addData("Heading ", currentHeading);
            telemetry.update();
    ...
    public void Ir2Beacon() {
        while (Multi.equals("Start4")) {
            ...
            //DAR VUELTA 2
            while (currentHeading > 85) { //PILA EN 13v ( ), EN -13v (15)
                GirarIzquierda(.2);
                currentHeading = GyroSensor.getHeading();
                telemetry.addData("Heading ", currentHeading);
                telemetry.update();
            ...
            //DAR VUELTA 3
            while (currentHeading < 175) { //PILA EN 13v ( ), EN -13v (290)
                GirarDerecha(.2);
                currentHeading = GyroSensor.getHeading();
                telemetry.addData("Heading ", currentHeading);
                telemetry.update();

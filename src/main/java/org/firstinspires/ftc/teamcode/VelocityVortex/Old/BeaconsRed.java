 ...
 */
//@Autonomous(name = "BeaconsRed")
public class BeaconsRed extends LinearOpMode {
...
*/
        ...
        while (GyroSensor.getHeading() > 185) {  //PILA EN 13v ( ), EN -13v (70)
            GirarIzquierda(.2);
        }
        Frenar();
    ...
    public void Ir2Beacon() {
        while (Multi.equals("Start4")) {
            ...
            //DAR VUELTA 2 <340
            while (GyroSensor.getHeading() < 240) { //PILA EN 13v ( ), EN -13v (15)
                GirarDerecha(.2);
            }
            Frenar();
            ...
            //DAR VUELTA 3 >290
            while (GyroSensor.getHeading() > 185) { //PILA EN 13v ( ), EN -13v (290)
                GirarIzquierda(.2);
            }
            Frenar();
    ...
    public void LanzarParticles(){
        while (Multi.equals("Start7")){
            ...
            //<315
            while (GyroSensor.getHeading() < 225) {
                GirarDerecha(.2);
            }
            Frenar();
            sleep(50);
